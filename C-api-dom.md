...
Toutes ces opérations se font obligatoirement via des méthodes JS associées aux éléments HTML. Pour pouvoir appeler ces méthodes depuis nos composants React, il faut donc récupérer des **"références"** vers ces éléments HTML.
