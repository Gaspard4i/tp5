...
# E. Debugger dans vscode : avec Firefox <!-- omit in toc -->
...
## E.1. Installer l'extension "Debugger for Firefox"
...
2. **Dans ce fichier `launch.json` collez le code suivant :**
	...
	> _Notez qu'on a précisé l'URL de notre application ReacTube (http://localhost:8000) dans la clé `"url"`._
...
5. **Vous pouvez maintenant lancer la session de debug, en appuyant simplement sur <kbd>F5</kbd>**
	...
	**Profitez-en pour installer l'extension "React Developer Tools"** dans cette instance de Firefox !


**Maintenant que l'extension Debugger for Firefox est configurée, revenez au readme précédent, directement à la partie : [E.2. Utilisation du mode debug](E-debug-vscode.md#b2-utilisation-du-mode-debug)**
