...
4. **Ouvrez le projet dans VSCodium** (pour les différentes façons d'ouvrir le projet relisez les [instructions du TP1](https://framagit.org/cours-react/tp1/-/blob/master/A-preparatifs.md#a4-ouvrir-le-projet-dans-vscodium) )
	```bash
