...
1. **Tapez dans un terminal :**
	...
	git clone git@github.com:formation-react/tp3.git
	codium tp3
	```
...
4. **Pour afficher votre site, plutôt que d'ouvrir vous-même votre navigateur, utilisez la fonctionnalité de debug dans VSCode configurée lors du précédent TP :**
	...
	>
	> _Je vous invite -avant de continuer la suite de ce TP- à reprendre le mini tutoriel du TP2 pour finaliser votre config et prendre en main cet outil : https://github.com/formation-react/tp2/blob/github/E-debug-vscode.md_
	> </details>
